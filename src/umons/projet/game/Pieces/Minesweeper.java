 ...
 * Classe dediee a la piece demineur
 *
 */

public class Minesweeper extends Piece {
	...
	public Minesweeper(Team pieceTeam, int piecePosition) {               //  1 correspond à aller vers la droite
		super(PieceType.MINESWEEPER, piecePosition, pieceTeam);           // -10 correspond à aller vers l'arriere
		this.pieceRank=2;                                                 //  10 correspond à aller vers l'avant
	} 
	...
	public String toString() {
		...
		return PieceType.MINESWEEPER.toString();
	}
	...
	@Override
	public Minesweeper movePiece(Move move) {
		
		return new Minesweeper(move.getMovedPiece().getPieceTeam(), move.getDestinationCoordinate());
	}
}
