 ...
 * Classe dediee a la piece colonel
 *
 */
...
public class Colonel extends Piece {
	...
	public Colonel(Team pieceTeam, int piecePosition) {                   //  1 correspond à aller vers la droite
		super(PieceType.COLONEL, piecePosition, pieceTeam);               // -10 correspond à aller vers l'arriere
		this.pieceRank=7;                                                 //  10 correspond à aller vers l'avant
	} 
	...
	public String toString() {
		...
		return PieceType.COLONEL.toString();
	}
	...
	@Override
	public Colonel movePiece(Move move) {
		
		return new Colonel(move.getMovedPiece().getPieceTeam(), move.getDestinationCoordinate());
	}
}
