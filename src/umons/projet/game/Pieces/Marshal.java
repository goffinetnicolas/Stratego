 ...
 * Classe dediee a la piece marechal 
 *
 */
...
public class Marshal extends Piece {
	...
	public Marshal(Team pieceTeam, int piecePosition) {                   //  1 correspond à aller vers la droite
		super(PieceType.MARSHAL, piecePosition, pieceTeam);               // -10 correspond à aller vers l'arriere
		this.pieceRank=9;                                                 //  10 correspond à aller vers l'avant
	} 
	...
	public String toString() {
		...
		return PieceType.MARSHAL.toString();
	}
	...
	@Override
	public Marshal movePiece(Move move) {
		
		return new Marshal(move.getMovedPiece().getPieceTeam(), move.getDestinationCoordinate());
	}
}
