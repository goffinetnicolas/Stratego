 ...
 * Classe dediee a la piece general 
 *
 */
...
public class General extends Piece {
	...
	public General(Team pieceTeam, int piecePosition) {                   //  1 correspond à aller vers la droite
		super(PieceType.GENERAL, piecePosition, pieceTeam);               // -10 correspond à aller vers l'arriere
		this.pieceRank=8;                                                 //  10 correspond à aller vers l'avant
	} 
	...
	public General movePiece(Move move) {
		...
		return new General(move.getMovedPiece().getPieceTeam(), move.getDestinationCoordinate());
	}
}
