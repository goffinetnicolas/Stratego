 ...
 * Classe dediee a la piece capitaine
 *
 */
...
public class Captain extends Piece {
	...
	public Captain(Team pieceTeam, int piecePosition) {                   //  1 correspond à aller vers la droite
		super(PieceType.CAPTAIN, piecePosition, pieceTeam);               // -10 correspond à aller vers l'arriere
	...
	public String toString() {
		...
		return PieceType.CAPTAIN.toString();
	}
	...
	@Override
	public Captain movePiece(Move move) {
		
		return new Captain(move.getMovedPiece().getPieceTeam(), move.getDestinationCoordinate());
	}
}
