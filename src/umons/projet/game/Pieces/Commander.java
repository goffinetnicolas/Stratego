 ...
 * Classe dediee a la piece commandant
 *
 */
...
public class Commander extends Piece {
	...
	public Commander(Team pieceTeam, int piecePosition) {                 //  1 correspond à aller vers la droite
		super(PieceType.COMMANDER, piecePosition, pieceTeam);             // -10 correspond à aller vers l'arriere
		this.pieceRank=6;                                                 //  10 correspond à aller vers l'avant
	} 
	...
	public String toString() {
		...
		return PieceType.COMMANDER.toString();
	}
	...
	@Override
	public Commander movePiece(Move move) {
		
		return new Commander(move.getMovedPiece().getPieceTeam(), move.getDestinationCoordinate());
	}
}