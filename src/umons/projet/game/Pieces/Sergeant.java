 ...
 * Classe dediee a la piece sergent
 *
 */
...
public class Sergeant extends Piece {
	...
	public Sergeant(Team pieceTeam, int piecePosition) {                  //  1 correspond à aller vers la droite
		super(PieceType.SERGEANT, piecePosition, pieceTeam);              // -10 correspond à aller vers l'arriere
		this.pieceRank=3;                                                 //  10 correspond à aller vers l'avant
	} 
	...
	public Sergeant movePiece(Move move) {
		...
		return new Sergeant(move.getMovedPiece().getPieceTeam(), move.getDestinationCoordinate());
	}
}